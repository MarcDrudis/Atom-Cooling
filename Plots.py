...
#Specific plots
def plot_heuristic_dL(monty_plot,lq,hq,constantdl=None):    
    ...
    fig.add_trace(go.Scatter(x=t*1000, y=current_dL, name='Current dL', line=dict(color='rgb(100,255,80)') ))
    
    if constantdl != None:
            fig.add_trace(go.Scatter(x=t*1000, y=np.full(monty_plot.timesteps,constantdl), name='Constant dL', line=dict(color='rgb(255,0,0)') ))
